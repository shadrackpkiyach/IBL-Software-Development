...
import 'package:guiding_light/screens/chat_screens/receivedmessagecard.dart';
import 'package:guiding_light/screens/chat_screens/sentmessagecard.dart';
  ...
  Future<void> connect() async {
    ...
    if (userDataRetrieved) {
      ...
      socket.on("notification", (data) {
        ...
        // Handle the incoming notification data here, update the UI, or show a notification to the user
      });
            ...
            SizedBox(
              ...
              child: ListView.builder(
                ...
                itemBuilder: (context, index) {
                  ...
                  // Display sent or received messages from the 'messages' list
